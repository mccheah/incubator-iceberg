...
public class TestSparkEncryption {
  ...
  public void testEncryptedWriteAndRead() throws IOException, NoSuchAlgorithmException {
    ...
    KeyPair keyEncryptionPair = KeyPairGenerator.getInstance(
        HadoopEncryptionManager.KEY_ENCRYPTION_DEFAULT_ALGORITHM)
        .generateKeyPair();
    ...
    conf.set(HadoopEncryptionManager.PRIVATE_KEY_CONF, privateKeyEncoded);
    conf.set(HadoopEncryptionManager.PUBLIC_KEY_CONF, publicKeyEncoded);
    ...
    table.updateProperties()
        ...
        .set("iceberg.hadoop." + HadoopEncryptionManager.PRIVATE_KEY_CONF, privateKeyEncoded)
        .set("iceberg.hadoop." + HadoopEncryptionManager.PUBLIC_KEY_CONF, publicKeyEncoded)
        .commit();
    testDataset.write()
