...
public class TestWriteEncryptionMetadata {
  ...
  public void testWriteEncryptionMetadata() throws IOException {
    ...
    DataFile dataFile = DataFiles.builder()
        ...
        .withEncryptionKeyMetadata(EncryptionKeyMetadatas.of(KEY_METADATA))
    ...
    Assert.assertNotNull(
        "Encryption metadata should have been written and read.", writtenFile.keyMetadata());
    Assert.assertArrayEquals(
        "Encryption key metadata was incorrect.",
        KEY_METADATA,
        ByteBuffers.copy(writtenFile.keyMetadata().keyMetadata()));
  }
}
