...
public class CryptoStreamWriter {
  ...
  public static PositionOutputStream encrypt(
      PositionOutputStream delegate, PhysicalEncryptionKey key) {
  ...
  public static OutputFile encrypt(OutputFile delegate, PhysicalEncryptionKey key) {
  ...
  private static final class EncryptedOutputFile implements OutputFile {
    ...
    private EncryptedOutputFile(OutputFile delegate, PhysicalEncryptionKey key) {
    ...
    public InputFile toInputFile() {
      return CryptoStreamReader.decrypt(delegate.toInputFile(), key);
    }
  }
